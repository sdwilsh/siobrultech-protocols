...
from siobrultech_protocols.gem.protocol import Packet
...
PACKETS = {
    "BIN32-ABS.bin": {
        ...
        "serial_number": 603,
        "device_id": 11,
        "temperatures": [None, -5, 0, 0, 0, 0, 0, 0],
        "voltage": 121.1,
    },
    "BIN32-NET.bin": {
        "absolute_watt_seconds": [
...
def read_packets(packet_file_names: Iterable[str]):
    result = bytearray()
...
def read_packet(packet_file_name: str):
